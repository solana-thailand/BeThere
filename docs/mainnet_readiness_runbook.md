...
- [x] **0.3 Prove `binary == source`:** `bash scripts/verify_devnet_binary.sh` (read-only, no keypair).
      Passed on 2026-08-08 (SHA256: `26380992e22a4784e40857dec77b708bdc0c1899b65cef2ce562c57e11900d80`).
- [x] **0.4 Cluster-selection defect (worker):** PR #51 merged (`seed_cluster_from_env`).
