...
`feature/linked-emails`; deployed (in prod tag `deploy/production/20260925T032335Z`; `issue_ledger.py` 2026-09-25 found every linked commit there). Re-check whether this attendee is still stuck.
