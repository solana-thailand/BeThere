...
config = {
    ...
    'organizer_emails': '$super_admins'.split(',') if '$super_admins' else ['organizer@example.test'],
    'staff_emails': '$staff_emails'.split(',') if '$staff_emails' else ['organizer@example.test'],
